...
df = pd.read_csv('assets/CTRC_ATRASADOS_ENTREGA.csv', encoding='Windows-1250', sep=';')
...
df_dim = pd.read_csv('assets/dOcorrencias.csv', encoding='UTF-8', sep=';')
...
if __name__ == '__main__':
    app.run_server(debug=False, port=8552)